# 04 — Serendipity Engine v0 实现规格（历史基线）

> **已被 v2 取代：** 用户在 2026-09-12 Critique #1 后明确反对用 Opening / Contrast / Surprise 精心编排个人印象。下一阶段算法以 `docs/10 §5–6` 与 `docs/11 §4` 的“先公平选书、再选划线；主题是书籍 scope”为准。本文件保留用于理解当前 `d9ceeb0` 实现与迁移测试，不再指导新功能。
